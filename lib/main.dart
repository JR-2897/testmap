...
import 'package:testmap/functions/geolocationHelper.dart';
      ...
      GoogleMap(
        ...
        */
        ...
        onMapCreated: (controller) async{
          String newStyle = await DefaultAssetBundle.of(context).loadString("assets/styles-map.json");
